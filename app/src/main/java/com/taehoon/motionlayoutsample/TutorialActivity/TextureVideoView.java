...
public class TextureVideoView extends MotionLayout
    ...
    private Runnable mControllerRunnable = new Runnable() {
        @Override
        public void run() {
            TransitionManager.beginDelayedTransition(TextureVideoView.this);
    ...
    private void setListener() {
        ...
        binding.tvPlaySpeed.setOnClickListener(TextureVideoView.this);
        binding.ivReplay.setOnClickListener(TextureVideoView.this);
    ...
    private void initView() {
        ...
        if (inflater != null) {
            View view = inflater.inflate(R.layout.view_tutorial, TextureVideoView.this, false);
            addView(view);
            ...
            if (binding != null) {
                ...
                mPlaySpeedAdapter = new PlaySpeedAdapter(TextureVideoView.this, mCurrPlaySpeed, PLAY_SPEEDS);
